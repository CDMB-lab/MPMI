function [G, stepflag]  = epc_mpmi_vv2(mi_G, corr_G, lambda)
%EPC_MPMI_VV2 Compute the network structure using extended path consistent
...
while (~stop)
   stepflag = stepflag + 1;
    ...
    tempG = cellfun(@(r, c, v) (mpmi(corr_G([r, c, v], [r, c, v]))>lambda), num2cell(edgerow), num2cell(edgecol), indx22);
