function [G, stepflag]  = epc_cmi_vv2(mi_G, corr_G, lambda)
%EPC_CMI_VV2 Compute the network structure using extended path consistent
...
while (~stop)
    ...
    tempG = cellfun(@(r, c, v) (cmi(corr_G([r, c, v], [r, c, v]))>lambda), num2cell(edgerow), num2cell(edgecol), indx22);
