...
%HIST4 
% Put Nsample*3 data x in to nbin(1)*nbin(2)*nbin(3) bins.
% nbins is not necessarry given by user.
% Out put nn is a 3-dim array and records the counts of samples in each bin.
